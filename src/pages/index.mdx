...
<Figure>
  <Image slot="figure" source={visual_dataset} altText="An example from our curated video question answering dataset." />
  <span slot="caption">An example from our curated video question answering dataset.</span>
</Figure>
